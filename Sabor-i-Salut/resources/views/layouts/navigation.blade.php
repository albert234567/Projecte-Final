        ...
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-500 hover:text-green-100 transition duration-150">
                            <div>{{ Auth::check() ? Auth::user()->name : 'Usuari' }}</div>
                            <div class="ms-1">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-green-500 text-white">
        ...
        <div class="pt-4 pb-1 border-t border-green-600">
            <div class="px-4">
                ...
                @else
                    <div class="font-medium text-base">Usuari</div>
                    <div class="font-medium text-sm">No autenticat</div>
                @endauth
            </div>
