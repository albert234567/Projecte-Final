            ...
            <div class="bg-white p-6 rounded-lg shadow">
                <form action="{{ route('plats.update', $plat->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nom" id="nom" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('nom', $plat->nom) }}" required>
                        @error('nom')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="descripcio" id="descripcio" rows="4" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{ old('descripcio', $plat->descripcio) }}</textarea>
                        @error('descripcio')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
